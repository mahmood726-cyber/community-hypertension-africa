# Community Hypertension Meta-Analysis (SSA)
# Author: Gemini CLI
# Date: 2026-04-27
library(metafor)
data <- read.csv("../data/raw_studies.csv")
trials <- data[data$study_id != "Standard_Care", ]
...
forest(res, transf=transf.ilogit, slab=trials$study_id, header=TRUE, 
       main="Community-Based Hypertension Control in SSA (Random-Effects)",
...
cat("=== Community Hypertension Meta-Analysis Summary ===\n")
print(summary(res))
